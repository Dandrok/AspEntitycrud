...
namespace Ecommerce.Controllers
{
    public class DepartamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentId,Name")] Departaments departaments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentId,Name")] Departaments departaments)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Não é possível remover o departamento porque existem cidades ligadas a ele, primeiro remova as cidades e volte a excluir.");
