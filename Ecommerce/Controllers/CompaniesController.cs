...
namespace Ecommerce.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        {
            var companies = db.Companies.Include(c => c.Cities).Include(c => c.Departament);
        ...
        public ActionResult Edit([Bind(Include = "CompanyId,Name,Phone,Address,Logo,DepartmentId,CityId")] Company company)
        {
            ...
            ViewBag.DepartmentId = new SelectList(db.Departaments, "DepartmentId", "Name", company.DepartmentId);
            return View(company);
        }
